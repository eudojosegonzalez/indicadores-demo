...
function filtrar2(){
    ...
    if (Math.abs(periodoId)<=Math.abs(periodo2Id)) {
        $.ajax({
            ...
            if (data[0].length > 0) {
                ...
                for (i=0; i < data[0].length; i++){
                    ...
                    cadena+="<td style='font-size:0.75em !important'>"+data[0][i]['definicion']+"</td>";
                    cadena+="<td style='font-size:0.75em !important'>"+data[0][i]['formula']+"</td>";
                    ...
                    for (j=0; j < ttt.length; j++)
                    {
                        ...
                        //console.log(t);                    
                        if (data[0][i]['unidad']=='%') {
                            cadena+="<td align='right' style='font-size:0.75em '>"+(t*100).toFixed(2)+" %</td>";
                        } else {               
                            cadena+="<td align='right' style='font-size:0.75em'>"+t.toFixed(2)+"</td>";
                        }
                    }
        ...
        titulo = 'Atención'
        parrafo = "<span class='text-danger'>El periodo final no puede ser inferior al periodo inicial</span>"
        $('#title_modal').html(titulo)
        $('#content_modal').html(parrafo)
        $('#myModal').modal()
    } 
