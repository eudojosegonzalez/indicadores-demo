 ...
 */
final class Version20220603020220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subreporte (id INT AUTO_INCREMENT NOT NULL, ente_id INT NOT NULL, reporte_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, procedimiento VARCHAR(255) NOT NULL, categoria_id INT NOT NULL, INDEX IDX_4EA9BADBEFB68F0A (ente_id), INDEX IDX_4EA9BADB92CA572 (reporte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
