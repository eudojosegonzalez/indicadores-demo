...
function filtrar(){
    ...
    $.ajax({
        ...
        if (data[0].length > 0) {
            ...
            cadena+="<div class='row'><table class='table table-striped table-bordered'><thead><tr align='center' class='boton02'><th>Item</th><th>Nombre</th><th>Valor</th></tr></thead><tbody>";
            for (i=0; i<data[0].length; i++){
                cadena+="<tr><td align='center'>"+(i+1)+"</td><td>"+data[0][i]['concepto']+"</td><td align='right'>";
