function pagina(){
    ...
    document.location = '/publico/public_index5/?can_reg='+can_reg+'&page=1&categoriaId='+categoriaId+'&id='+enteId; 
}
...
function limpiar(){
    ...
    $('#content_modal').html(parrafo)
    $('#myModal').modal()
    document.location = '/publico/public_index5/?can_reg='+can_reg+'&page=1+&id=1';    
}