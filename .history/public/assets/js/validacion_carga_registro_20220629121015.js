function filtrar(){
    ...
    $.ajax({
        ...
        if (data.length > 0) {
            ...
            cadena+="<div class='col-12 text-right'><input type='button' id='btn001' class='btn boton02' value='Guardar' onclick='guardar()'></div>";
            cadena+="</div>";
...
function guardar(){
    document.getElementById("btn001").disabled=true;
    var f = $(this);
