...
function filtrar(){
    ...
    $.ajax({
        ...
        if (data[0].length > 0) {
            ...
            cadena+="<div class='col-12 text-right'><button  class='btn boton02' onClick=window.open('"+data[1]+"')>Descarga <img src='../assets/images/pdf.png' width='36' heigth='auto'></button></div>";
            cadena+="</div>";
