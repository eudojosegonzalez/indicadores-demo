...
function filtrar(){
    ...
    $.ajax({
        ...
        if (data[0].length > 0) {
            ...
            cadena+="<tr align='center' class='boton02'><th colspan='4'></th><th colspan="+ nperiodos.trim() +">Periodos</th></tr>";
            ...
            for (i=0; i < data[0].length; i++){
                ...
                var t=Math.abs(data[0][i]['valor']);
                console.log(t.toFixed(2));
                if (data[0][i]['unidad']=='%') {
                    cadena+="<td align='right'><label>"+(t*100).toFixed(2)+" %";
                } else {               
                    cadena+="<td align='right'><label>"+t.toFixed(2);
                }
                cadena+"</label></td></tr>";                
            }
