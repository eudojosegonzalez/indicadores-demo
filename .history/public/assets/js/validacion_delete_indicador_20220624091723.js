function borrar(id) {
    var rrr=confirm("¿Está seguro de que desea eliminar este Registro de la Base de Datos?");
    if (rrr==true){
        titulo = 'Atención'
...
function ocultar(){
    var rrr=confirm("¿Está seguro de que desea Ocultar este Registro de la Base de Datos?\nLas Formulas dependientes de Elementos OCULTOS no serán visibles en los reportes involucrados");
    if (rrr){
        titulo = 'Atención'
        parrafo = "<span class='text-success'>Espere por favor<p  align='center'><img src='../../assets/images/wait2.gif' width='50' height='50'></span>"
        $('#title_modal').html(titulo)
