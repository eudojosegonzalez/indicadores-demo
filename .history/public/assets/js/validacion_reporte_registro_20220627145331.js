...
function filtrar(){
    ...
    $.ajax({
        ...
        if (data[0].length > 0) {
            ...
            cadena+="<th>Definición</th><th>Fórmula</th><th>Valor</th></tr></thead><tbody>";
            for (i=0; i<data[0].length; i++){
                cadena+="<tr><td align='center'>"+(i+1)+"</td><td>"+data[0][i]['concepto']+"</td>";
                cadena+="<tr><td align='center'>"+(i+1)+"</td><td>"+data[0][i]['definicion']+"</td>";
                cadena+="<tr><td align='center'>"+(i+1)+"</td><td>"+data[0][i]['formula']+"</td>";
                cadena+="<td align='right'><label>"+data[0][i]['valor']+"</label></td></tr>";                
            }
