                ...
                */
                ...
                for ($i = 1; $i < $nperiodos; $i++) {
                    ...
                    if ($i == 1) {
                        ...
                        $resultados[$i]["concepto"] = $resp1['concepto'];
                        $resultados[$i][["unidad"] = $resp1['unidad'];
                        $resultados[$i][[$i][["nombre"] = $resp1['nombre'];
                        $resultados[$i][["definicion"] = $resp1['definicio'];
                        $resultados[$i][["formula"] = $resp1['formula'];
                        $resultados[$i][["resultados"][0] = $resp1['valor'];
                    } else {
                        $resultados[$i]["resultados"][($i - 1)] = $resp1['valor'];
                    }
                }
                dd($resultados);
                // este funciona
