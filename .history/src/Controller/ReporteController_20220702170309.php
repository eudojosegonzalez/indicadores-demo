            ...
            case "1": // CNED
                ...
                */
                ...
                for ($i = 1; $i < $nperiodos; $i++) {
                    ...
                    if ($i == 1) {
                        //---- es el primer set de resultados
                        $resultados[$i]["concepto"] = $resp1[0]['concepto'];
                        $resultados[$i]["unidad"] = $resp1[0]['unidad'];
                        $resultados[$i]["nombre"] = $resp1[0]['nombre'];
                        $resultados[$i]["definicion"] = $resp1[0]['definicion'];
                        $resultados[$i]["formula"] = $resp1[0]['formula'];
                        $resultados[$i]["resultados"][0] = $resp1[0]['valor'];
                    } else {
                        $resultados[$i]["resultados"][($i - 1)] = $resp1[($i - 1)]['valor'];
                    }
                }
                dd($resultados);
                // este funciona
