...
class ReporteController extends AbstractController
{
    ...
    public function searchIndicadores(
        ...
        if ($indicadores) {
            ...
            $sheet->getStyle("A6:" . chr($nletra - 1) . "5")->getFont()->setBold(true)->setSize(16)
                ->getColor()
                ->setRGB('FFFFFF');
            $sheet->getStyle("A6:" . chr($nletra - 1) . "5")->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)
                ->getStartColor()
                ->setARGB('16626f');
