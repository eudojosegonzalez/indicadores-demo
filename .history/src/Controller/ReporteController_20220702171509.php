                ...
                */
                ...
                for ($i = 1; $i < $nperiodos; $i++) {
                    ...
                    foreach ($resp1 as $resp) {
                        ...
                        $resultados[$i]["concepto"] = $resp['concepto'];
                        $resultados[$i]["unidad"] = $resp['unidad'];
                        $resultados[$i]["nombre"] = $resp['nombre'];
                        $resultados[$i]["definicion"] = $resp['definicion'];
                        $resultados[$i]["formula"] = $resp['formula'];
                        $resultados[$i]["resultados"][($i - 1)] = $resp['valor'];
                    }
                }
                dd($resultados);
                // este funciona
