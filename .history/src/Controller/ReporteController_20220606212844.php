...
class ReporteController extends AbstractController
{
    ...
    public function searchIndicadores(
        ...
        $logo = __DIR__ . '../../public/assets/images/logo2.png';
        ...
        $pdfFilepath =  $this->getParameter('archivos') . $slugger->slug($ente->getNombre() . '-' . $reporte->getTitulo() . "-" . $periodo->getNombre() . uniqid()) . '.pdf';
