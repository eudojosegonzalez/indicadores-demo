...
class CategoriaController extends AbstractController
{
     ...
     */
    public function index(CategoriaRepository $categoriaRepository, PaginatorInterface $paginator, Request $request): Response
    {

        //$misRegistros = $registroRepository->findAll();
        $canReg = $request->query->getInt('can_reg', 5);
