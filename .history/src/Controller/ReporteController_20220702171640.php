                ...
                */
                ...
                for ($i = 1; $i < $nperiodos; $i++) {
                    ...
                    foreach ($resp1 as $resp) {
                        ...
                        $resultados[]["concepto"] = $resp['concepto'];
                        $resultados[]["unidad"] = $resp['unidad'];
                        $resultados[]["nombre"] = $resp['nombre'];
                        $resultados[]["definicion"] = $resp['definicion'];
                        $resultados[]["formula"] = $resp['formula'];
                        $resultados[]["resultados"][($i - 1)] = $resp['valor'];
                    }
                }
                dd($resultados);
                // este funciona
