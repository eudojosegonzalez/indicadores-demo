...
class PeriodoController extends AbstractController
{
     ...
     */
    public function new(Request $request, PeriodoRepository $periodoRepository, EnteRepository $enteRepository): Response
    {
        $entes = $enteRepository->findAll();
        $periodo = new Periodo();
     ...
     */
    public function show(Periodo $periodo, EnteRepository $enteRepository): Response
    {
        $entes = $enteRepository->findAll();
     ...
     */
    public function edit(Request $request, Periodo $periodo, PeriodoRepository $periodoRepository, EnteRepository $enteRepository): Response
    {
        $entes = $enteRepository->findAll();
        $form = $this->createForm(PeriodoType::class, $periodo);
        $form->handleRequest($request);
